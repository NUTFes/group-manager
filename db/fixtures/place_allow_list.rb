PlaceAllowList.seed( :id,
  ...
  { id: 61,  place_id: 5,  group_category_id: 6, enable: true }, #セコムホール
  { id: 62,  place_id: 6,  group_category_id: 6, enable: false }, #電気棟204
  { id: 63,  place_id: 7,  group_category_id: 6, enable: false }, #電気棟206
  { id: 64,  place_id: 8,  group_category_id: 6, enable: false }, #電気棟208
  { id: 65,  place_id: 9,  group_category_id: 6, enable: false }, #電気棟212
  { id: 66,  place_id: 10, group_category_id: 6, enable: false }, #電気棟310
  { id: 67,  place_id: 11, group_category_id: 6, enable: true }, #講義棟部屋A
  { id: 68,  place_id: 12, group_category_id: 6, enable: true }, #講義棟部屋B
  { id: 69,  place_id: 13, group_category_id: 6, enable: false }, #マルチメディア
  { id: 70,  place_id: 14, group_category_id: 6, enable: true }, #グラウンド
  # 規定外の場所の追加
  { id: 71,  place_id: 15, group_category_id: 1, enable: true }, # 模擬店(食品販売)
  { id: 72,  place_id: 15, group_category_id: 2, enable: true}, # 模擬店(物品販売)
  { id: 73,  place_id: 15, group_category_id: 4, enable: true }, # 展示
  { id: 74,  place_id: 15, group_category_id: 5, enable: true }, # その他
